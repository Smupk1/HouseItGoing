...
const Header = () => {
    ...
    return (
        <nav className="flex items-center bg-neutral-800 w-full z-20 fixed top-0 left-0 h-20 px-4">
            {/* Logo and Brand Name */}
            <div className="flex items-center">
                ...
                <Link className="text-2xl text-white font-bold" to={'/home'}>
                    House It Going
                </Link>
            </div>
            ...
            <div className="flex items-center gap-x-4 ml-auto">
                {userLoggedIn ? (
                    <>
                        <Link className="text-2xl text-white font-bold" to={'/calculator'}>
                            Calculator
                        </Link>
                        <Link className="text-2xl text-white font-bold" to={'/compare'}>
                            Side-By-Side
                        </Link>
                        <button
                    ...
                    <>
                        <Link className="text-2xl text-white font-bold" to={'/login'}>
                            Login
                        </Link>
                        <Link className="text-2xl text-white font-bold" to={'/register'}>
                            Register
                        </Link>
                    </>
                )}
