    ...
    return (
        ...
        <div class="bg-neutral-800 flex justify-center items-center overflow-auto ">
            ...
            <div class="w-1/2 h-screen hidden lg:block">
                <img src="https://i.imgur.com/mPg03l8.jpeg?w=826" alt="Placeholder Image" class="object-cover w-full h-full"></img>
            </div>
                    ...
                    <div >
                        ...
                        <div className=" mt-8 w-96 dark:text-white bg-neutral-900 space-y-5 p-4 shadow-xl border rounded-xl  margin-top: 50px">
                            <div className="text-center">
                                <div className="mt-2">
                                    <h3 className="dark:text-white  text-xl font-semibold sm:text-2xl">Welcome Back</h3>
                                </div>
                            </div>
                            <form
                                onSubmit={onSubmit}
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full mt-2 px-3 py-2 dark:text-gray-400 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg transition duration-300"
                                    />
                                </div>
                                ...
                                <button
                                    ...
                                    className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-teal-600 hover:bg-teal-700 hover:shadow-xl transition duration-300'}`}
                                >
